...
#ifndef ARMCHAIR_SWIFT_H
#define ARMCHAIR_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Armchair",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_PROTOCOL("_TtP8Armchair22ArmchairDefaultsObject_")
@protocol ArmchairDefaultsObject
...
SWIFT_CLASS("_TtC8Armchair15ArmchairManager")
@interface ArmchairManager : NSObject <SKStoreProductViewControllerDelegate>
...
SWIFT_CLASS("_TtC8Armchair7Manager")
@interface Manager : ArmchairManager
- (void)productViewControllerDidFinish:(SKStoreProductViewController * _Null_unspecified)viewController;
